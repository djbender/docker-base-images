...
target "ruby" {
  target = "ruby"
  tags = ["ghcr.io/djbender/ruby:4.0", "ghcr.io/djbender/ruby:4.0-noble", "ghcr.io/djbender/ruby:4.0.0", "ghcr.io/djbender/ruby:4.0.0-noble", "ghcr.io/djbender/ruby:latest"]
...
target "ruby-dev" {
  target = "ruby-dev"
  inherits = ["ruby"]
  tags = ["ghcr.io/djbender/ruby:4.0-dev-noble", "ghcr.io/djbender/ruby:4.0.0-dev", "ghcr.io/djbender/ruby:4.0.0-dev-noble", "ghcr.io/djbender/ruby:dev"]
  cache-from = [
