...
target "ruby" {
  target = "ruby"
  tags = ["ghcr.io/djbender/ruby:3.3", "ghcr.io/djbender/ruby:3.3-noble", "ghcr.io/djbender/ruby:3.3.10", "ghcr.io/djbender/ruby:3.3.10-noble"]
...
target "ruby-dev" {
  target = "ruby-dev"
  inherits = ["ruby"]
  tags = ["ghcr.io/djbender/ruby:3.3-dev", "ghcr.io/djbender/ruby:3.3-dev-noble", "ghcr.io/djbender/ruby:3.3.10-dev", "ghcr.io/djbender/ruby:3.3.10-dev-noble"]
  cache-from = [
