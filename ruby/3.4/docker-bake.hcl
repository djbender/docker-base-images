...
target "ruby" {
  target = "ruby"
  tags = ["ghcr.io/djbender/ruby:3.4", "ghcr.io/djbender/ruby:3.4-noble", "ghcr.io/djbender/ruby:3.4.8", "ghcr.io/djbender/ruby:3.4.8-noble", "ghcr.io/djbender/ruby:latest"]
...
target "ruby-dev" {
  target = "ruby-dev"
  inherits = ["ruby"]
  tags = ["ghcr.io/djbender/ruby:3.4-dev-noble", "ghcr.io/djbender/ruby:3.4.8-dev", "ghcr.io/djbender/ruby:3.4.8-dev-noble", "ghcr.io/djbender/ruby:dev"]
  cache-from = [
