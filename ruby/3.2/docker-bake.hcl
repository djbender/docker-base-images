...
target "ruby" {
  target = "ruby"
  tags = ["ghcr.io/djbender/ruby:3.2", "ghcr.io/djbender/ruby:3.2-noble", "ghcr.io/djbender/ruby:3.2.9", "ghcr.io/djbender/ruby:3.2.9-noble"]
...
target "ruby-dev" {
  target = "ruby-dev"
  inherits = ["ruby"]
  tags = ["ghcr.io/djbender/ruby:3.2-dev", "ghcr.io/djbender/ruby:3.2-dev-noble", "ghcr.io/djbender/ruby:3.2.9-dev", "ghcr.io/djbender/ruby:3.2.9-dev-noble"]
  cache-from = [
