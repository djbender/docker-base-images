...
target "ruby" {
  target = "ruby"
  tags = [
    "ghcr.io/djbender/ruby:3.0",
    "ghcr.io/djbender/ruby:3.0-noble",
    "ghcr.io/djbender/ruby:3.0.7",
    "ghcr.io/djbender/ruby:3.0.7-noble"
  ]
...
target "ruby-dev" {
  ...
  inherits = ["ruby"]
  tags = [
    "ghcr.io/djbender/ruby:3.0-dev",
    "ghcr.io/djbender/ruby:3.0-dev-noble",
    "ghcr.io/djbender/ruby:3.0.7-dev",
