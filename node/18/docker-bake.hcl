...
target "node" {
  tags = ["ghcr.io/djbender/node:18", "ghcr.io/djbender/node:18-", "ghcr.io/djbender/node:18--noble", "ghcr.io/djbender/node:18.16.0-", "ghcr.io/djbender/node:18.16.0--noble"]
  context = "${PWD}/node/18"
