...
target "node" {
  tags = ["ghcr.io/djbender/node:16", "ghcr.io/djbender/node:16-", "ghcr.io/djbender/node:16--noble", "ghcr.io/djbender/node:16.20.0-", "ghcr.io/djbender/node:16.20.0--noble"]
  context = "${PWD}/node/16"
