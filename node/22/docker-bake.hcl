...
target "node" {
  target = "node"
  tags = ["ghcr.io/djbender/node:22", "ghcr.io/djbender/node:22-noble", "ghcr.io/djbender/node:22.19.0", "ghcr.io/djbender/node:22.19.0-noble"]
  context = "${PWD}/node/22"
...
target "node-dev" {
  target = "node-dev"
  inherits = ["node"]
  tags = ["ghcr.io/djbender/node:22-dev", "ghcr.io/djbender/node:22-dev-noble", "ghcr.io/djbender/node:22.19.0-dev", "ghcr.io/djbender/node:22.19.0-dev-noble"]
  cache-from = [
