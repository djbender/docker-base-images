...
target "node" {
  target = "node"
  tags = ["ghcr.io/djbender/node:24", "ghcr.io/djbender/node:24-noble", "ghcr.io/djbender/node:24.5.0", "ghcr.io/djbender/node:24.5.0-noble", "ghcr.io/djbender/node:latest"]
  context = "${PWD}/node/24"
